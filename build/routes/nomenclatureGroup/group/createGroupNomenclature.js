...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.post("/api/v1/nomenclatureGroup/:contextId/category/:categoryId/create_group", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (context instanceof spinal_env_viewer_graph_service_1.SpinalContext && category.belongsToContext(context)) {
                if (context.getType().get() === "AttributeConfigurationGroupContext") {
                    var group = yield spinal_env_viewer_plugin_group_manager_service_1.default.addGroup(context.getId().get(), category.getId().get(), req.body.groupName, req.body.colorName);
                    var info = {
...
//# sourceMappingURL=createGroupNomenclature.js.map