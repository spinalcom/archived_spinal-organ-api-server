...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.delete("/api/v1/nomenclatureGroup/:contextId/category/:categoryId/delete", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (context instanceof spinal_env_viewer_graph_service_1.SpinalContext && category.belongsToContext(context)) {
                if (context.getType().get() === "AttributeConfigurationGroupContext") {
                    yield spinal_env_viewer_graph_service_1.SpinalGraphService.removeFromGraph(category.getId().get());
                }
                else {
...
//# sourceMappingURL=deleteCategoryNomenclature.js.map