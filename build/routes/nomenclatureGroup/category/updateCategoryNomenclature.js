...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.put("/api/v1/nomenclatureGroup/:contextId/category/:categoryId/update", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (context instanceof spinal_env_viewer_graph_service_1.SpinalContext && category.belongsToContext(context)) {
                if (context.getType().get() === "AttributeConfigurationGroupContext") {
                    ...
                    var categoryUpdated = yield spinal_env_viewer_plugin_group_manager_service_1.default.updateCategory(category.getId().get(), dataObject);
                    var info = {
