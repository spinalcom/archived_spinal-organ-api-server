...
module.exports = function (logger, app, spinalAPIMiddleware) {
   ...
   */
    app.get("/api/v1/room/:id/endpoint_list", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        let nodes = [];
        try {
            ...
            if (room.getType().get() === "geographicRoom") {
                var endpoints = yield room.getChildren(["hasEndPoint", spinal_model_bmsnetwork_1.SpinalBmsEndpoint.relationName]);
