...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    */
    app.put("/api/v1/ticket/:ticketId/change_workflow", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield spinal_service_ticket_1.serviceTicketPersonalized.changeTicketProcess(ticket.getId().get(), process.getId().get(), workflow.getId().get());
        }
        catch (error) {
            console.log(error);
