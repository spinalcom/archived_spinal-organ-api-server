...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    */
    app.post("/api/v1/ticket/:ticketId/next_step", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield spinal_service_ticket_1.serviceTicketPersonalized.moveTicketToNextStep(workflow.getId().get(), process.getId().get(), ticket.getId().get());
