...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     */
    app.delete('/api/v1/endPointsGroup/:contextId/category/:categoryId/group/:groupId/deleteEndpoint', (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
                ...
                if (context.getType().get() === 'BmsEndpointGroupContext') {
                    if (_endpointList.length > 0) {
                        for (let index = 0; index < _endpointList.length; index++) {
                            let realNode = yield spinalAPIMiddleware.load(_endpointList[index]);
                            //@ts-ignore
...
//# sourceMappingURL=deleteEndPointList.js.map