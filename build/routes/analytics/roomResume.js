        ...
        try {
            ...
            if (room.getType().get() === "geographicRoom") {
                ...
                for (let index = 0; index < ticketListRoom.length; index++) {
                    ...
                    //Step
                    var _step = yield realNodeTicket.getParents("SpinalSystemServiceTicketHasTicket").then((steps) => {
                ...
                for (const equipement of equipements) {
                    ...
                    for (const ticketEquipemnt of ticketListEquipemnt) {
                        ...
                        //Step
                        var _stepTicketEquipement = yield realNodeEquipementTicket.getParents("SpinalSystemServiceTicketHasTicket").then((steps) => {
                            for (const step of steps) {
                                if (step.getType().get() === "SpinalSystemServiceTicketTypeStep") {
                                    return step;
                                }
                ...
                for (const objectEquipement of _ticketListEquipemnt) {
                    ...
                    if (objectEquipement.priority === 0 || objectEquipement.priority === "0")
                        Occasionally++;
                    else if (objectEquipement.priority === 1 || objectEquipement.priority === "1")
                        Normal++;
                    else if (objectEquipement.priority === 2 || objectEquipement.priority === "2")
                        Urgent++;
                }
                ////////////////////////////////// Mark //////////////////////////////////////////
                var mark = 20;
