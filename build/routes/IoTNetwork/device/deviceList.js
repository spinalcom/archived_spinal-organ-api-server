...
module.exports = function (logger, app, spinalAPIMiddleware) {
   ...
   */
    app.get("/api/v1/Network/:id/device_list", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        let nodes = [];
        try {
            const profileId = (0, requestUtilities_1.getProfileId)(req);
            let network = yield spinalAPIMiddleware.load(parseInt(req.params.id, 10), profileId);
            // @ts-ignore
            spinal_env_viewer_graph_service_1.SpinalGraphService._addNode(network);
            var devices = yield network.getChildren("hasBmsDevice");
