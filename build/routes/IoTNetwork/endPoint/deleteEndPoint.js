...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.delete("/api/v1/endpoint/:id/delete", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            const profileId = (0, requestUtilities_1.getProfileId)(req);
            let endpoint = yield spinalAPIMiddleware.load(parseInt(req.params.id, 10), profileId);
            // @ts-ignore
