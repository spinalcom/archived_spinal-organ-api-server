...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.put("/api/v1/Network/:id/update", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            const profileId = (0, requestUtilities_1.getProfileId)(req);
            var network = yield spinalAPIMiddleware.load(parseInt(req.params.id, 10), profileId);
            // @ts-ignore
