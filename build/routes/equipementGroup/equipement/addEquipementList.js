...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     */
    app.post('/api/v1/equipementsGroup/:contextId/category/:categoryId/group/:groupId/addEquipements', (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
                ...
                if (context.getType().get() === 'BIMObjectGroupContext') {
                    if (_equipementList.length > 0) {
                        for (let index = 0; index < _equipementList.length; index++) {
                            let realNode = yield spinalAPIMiddleware.load(_equipementList[index]);
                            //@ts-ignore
...
//# sourceMappingURL=addEquipementList.js.map