...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.put("/api/v1/equipementsGroup/:id/update", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (groupContext.getType().get() === "BIMObjectGroupContext") {
                groupContext.getName().set(req.body.newGroupEquipementContextName);
            }
            else {
